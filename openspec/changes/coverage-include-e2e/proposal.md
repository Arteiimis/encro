...
- Expected effect: src line coverage rises from 82.79% toward ~90%+ with the exclusions making the remaining number honest; e2e wall time shrinks by the 18 pruned process startups.
...
- `tests/e2e/encro_e2e_tests.cpp`: remove 18 cases, move 1 harness self-test; `tests/unit` side gains nothing (the 18 duplicates' unit counterparts already exist and stay).
