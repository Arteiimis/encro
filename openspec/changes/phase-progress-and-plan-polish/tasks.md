...
- [x] 7.4 Commits: `33631cb` (planning artifacts, before implementation), then `a4d903f` (core shared pieces), `7927211` (bar clearing per phase) and `dc0e029` (phase summary lines) — each implementation commit carries its tests and the tasks it completes.
